...
public class LoginController {
    ...
    public void loginAccount() throws SQLException, IOException {
        ...
        String dataBaseName = loginUsernameText.getText().replaceAll("\\s", "");
        singleton.setUsername(loginUsernameText.getText());
        singleton.setDatabaseName(dataBaseName);
        //Set Up Fail Alert
        Alert failAlert = new Alert(Alert.AlertType.WARNING);
        Image fail = new Image("D:\\Assignment\\Semester 2\\Object Oriented Programming\\JavaFXTest\\Repertoire\\graphic\\fail.png");
        ImageView failIcon = new ImageView(fail);
        failAlert.setTitle("Failed!");
        failAlert.setGraphic(failIcon);
